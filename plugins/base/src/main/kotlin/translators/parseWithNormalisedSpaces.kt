 ...
 */
internal fun String.parseWithNormalisedSpaces(parseAsHtml: Boolean, renderWhiteCharactersAsSpaces: Boolean): List<DocTag> {
    ...
    val encoded =
        if (parseAsHtml) Jsoup.parseBodyFragment(this).body().wholeText()
        else this
